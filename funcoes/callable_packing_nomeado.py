...
if __name__ == '__main__':
    ...
    preco_bruto = 5000
    preco_final_foguete = calcula_preco(preco_bruto, imposto_x, importado=True)
    preco_final_foguete = calcula_preco(preco_final_foguete, imposto_y,
                                         explosivo=True, nivel_perigo=5)
